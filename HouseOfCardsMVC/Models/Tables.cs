        ...
        public static List<Card> CardTypes
        {
            get
            {
                return new List<Card>
                {
                    ...
                    new Card { Id = 0,  Type = "Scandal", Description = "a", Name = "Collude with the Russians",
                    ...
                    new Card { Id = 5,  Type = "Scandal", Description = "t", Name = "Publically lie",
                        Dirty = true, Image = "", Phase = 1, Score = 3000, Attack = 0, Defense = 100, Target = List_CardTargets.Self },
                    ...
                    new Card { Id = 22, Type = "Twist", Description = "Everyone that played a legal card loses 100 points", Name = "Rate Race", Dirty = false, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Global },
                    ...
                    new Card { Id = 53, Type = "Twist", Description = "Target only receives 3 cards in round 2", Name = "Intercept delivery", Dirty = false, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Other },

                    new Card { Id = 28, Type = "Investigation", Description = "Your have an inside person who is able to feed you information about your opponents actions.", Name = "Hire a PI", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Other },
                    new Card { Id = 29, Type = "Investigation", Description = "/", Name = "Audit Financial records", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Other },
                    new Card { Id = 30, Type = "Investigation", Description = ";", Name = "Look through their rubbish to find dirt", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Other },
                    new Card { Id = 31, Type = "Investigation", Description = ";", Name = "Conduct a federal investigation", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Other },
                    new Card { Id = 32, Type = "Investigation", Description = ";", Name = "Interview employees", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Other },
                    new Card { Id = 33, Type = "Investigation", Description = ";", Name = "Send Death Threat", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Other },
                    new Card { Id = 34, Type = "Investigation", Description = ";", Name = "Hire a photographer to follow someone around", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Other },

                    new Card { Id = 35, Type = "Defense", Description = ";", Name = "Alibi", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 36, Type = "Defense", Description = ";", Name = "Call an emergency press conference", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 37, Type = "Defense", Description = ";", Name = "Political rebuttal", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 38, Type = "Defense", Description = ";", Name = "Feign ignorance", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 40, Type = "Defense", Description = ";", Name = "Make a public apology", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 41, Type = "Defense", Description = ";", Name = "Fire your second in command", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 42, Type = "Defense", Description = ";", Name = "Take a trip to the Bahamas", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 43, Type = "Defense", Description = ";", Name = "Call the media “Fake News”", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 44, Type = "Defense", Description = ";", Name = "Make fake promises", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 45, Type = "Defense", Description = ";", Name = "Point fingers", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 46, Type = "Defense", Description = ";", Name = "Find a scapegoat", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 21, Type = "Defense", Description = "No one understands ho to use your accounting package, getting tax records out of this will be impossible", Name = "Outdated accounting software",
                        Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Global },
                    new Card { Id = 21, Type = "Defense", Description = "You have hired a body dboule to act on your behalf in public while you lurk from the shadows", Name = "Body Double",
                        Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Global },
