        ...
        public static List<Card> CardTypes
        {
            get
            {
                return new List<Card>
                {
                    ...
                    new Card { Id = 1,  Category = "", Description = "q", Name = "Hack into another players emails", Dirty = true, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 2,  Category = "", Description = "w", Name = "Evade tax", Dirty = true, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 3,  Category = "", Description = "e", Name = "Plant incriminating documents in someone’s office", Dirty = true, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },
                    ...
                    new Card { Id = 6,  Category = "", Description = "y", Name = "Organise assassination ", Dirty = true, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 7,  Category = "", Description = "Threaten to nuke another country", Name = "Flaunt your big red button", Dirty = true, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },
                    ...
                    new Card { Id = 10, Category = "", Description = "p", Name = "Cut off your opponents finger and feed it to your dog to get rid of the evidence", Dirty = true, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },
                    ...
                    new Card { Id = 12, Category = "", Description = "s", Name = "Win a debate against another player", Dirty = false, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 13, Category = "", Description = "d", Name = "Post an unsavoury video of another player", Dirty = false, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },
                    ...
                    new Card { Id = 15, Category = "", Description = "g", Name = "Accidentally’ tell a bad story about another player during an interview", Dirty = false, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },
                    ...
                    new Card { Id = 21, Category = "", Description = "x", Name = "Get an unflattering caricature of your opponent published", Dirty = false, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },

                    new Card { Id = 22, Category = "", Description = "c", Name = "Everyone that played a legal card loses 100 points", Dirty = false, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 23, Category = "", Description = "v", Name = "Everyone that played an illegal card loses 300 points", Dirty = false, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 24, Category = "", Description = "b", Name = "Choose someone that won’t be able to select which card they play next turn", Dirty = false, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 25, Category = "", Description = "n", Name = "Everyone loses 150 points", Dirty = false, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },
                    ...
                    new Card { Id = 27, Category = "", Description = ",", Name = "Nobody gets defence cards in round 2", Dirty = false, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 53, Category = "", Description = ",", Name = "Target only receives 3 cards in round 2", Dirty = false, Image = "", Phase = 1, Score = 0, Target = List_CardTargets.Self },

                    new Card { Id = 28, Category = "", Description = ".", Name = "Hire a PI", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 29, Category = "", Description = "/", Name = "Audit Financial records", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 30, Category = "", Description = ";", Name = "Look through their rubbish to find dirt", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 31, Category = "", Description = ";", Name = "Conduct a federal investigation", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 32, Category = "", Description = ";", Name = "Interview employees", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 33, Category = "", Description = ";", Name = "Send Death Threat", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 34, Category = "", Description = ";", Name = "Hire a photographer to follow someone around", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    ...
                    new Card { Id = 48, Category = "", Description = ";", Name = "Make investigation cards work incorrectly", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 49, Category = "", Description = ";", Name = "Nobody’s defence cards work", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    new Card { Id = 50, Category = "", Description = ";", Name = "Players that play illegal cards only get half the points they should if they’re successful", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                    ...
                    new Card { Id = 52, Category = "", Description = ";", Name = "Swap pending points with another player", Dirty = false, Image = "", Phase = 2, Score = 0, Target = List_CardTargets.Self },
                };
            }
        }
